...
import type { MetadataEditor, MetadataEditorState } from "./useMetadataEditor";
...
interface PaneNoticesProps {
  state: MetadataEditorState;
}

function PaneNotices({ state }: PaneNoticesProps) {
...
type LocalePaneProps = MetadataEditor;

export function LocalePane({ actions, computed, state }: LocalePaneProps) {
