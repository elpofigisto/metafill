...
import { LOCALE_LABELS, metadataFileLimit } from "../app-store-metadata.js";
...
export function buildUserPrompt({ fileName, sourceText, locale, translatedName, translatedSubtitle }) {
